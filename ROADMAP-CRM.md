...
- [x] Confirmar `form.planespro.cl` como endpoint p?blico del backend
...
- [ ] Incluir `isapre_espec?fica`
- [ ] Incluir `comentarios`
- [ ] Incluir `pdf_object_key`
- [ ] Definir convencion de nombres y estados
- [ ] Documentar estructura t?cnica minima
...
- [x] Crear b?squeda por nombre
- [x] Crear b?squeda por email
- [x] Crear b?squeda por tel?fono
- [x] Crear b?squeda por RUT
- [x] Crear filtro por fecha
- [x] Crear filtro por sistema
- [x] Crear filtro por isapre espec?fica
...
- [x] Agregar resumen de agenda con pr?ximas citas
...
- [x] Agregar auditor?a basica de acci?nes

### Trazabilidad
- [x] Crear tabla `lead_notes`
- [x] Crear tabla `lead_events`
- [x] Guardar qui?n hizo cada acci?n
...
- [x] Crear lista de pr?ximas citas
- [x] Crear indicadores de citas de hoy, pendientes y pr?ximas
...
### Panel por asesor
- [ ] Crear dashboard b?sico por asesor
...
- [ ] Crear panel global de m?tricas
- [ ] Medir campa?as y origen de leads

## Fase 4 - Colaboraci?n interna
- [ ] Crear sistema de reasignaci?n manual
- [ ] Registrar historial de cesi?n
...
- [ ] Disenar perfil b?sico del asesor
...
- [ ] Definir reglas de compra/cesi?n
...
- [ ] Asociar asesores a organizaci?nes
- [ ] Aislar datos por organizaci?n
...
- [ ] Evaluar recuperacion de contrase?a
